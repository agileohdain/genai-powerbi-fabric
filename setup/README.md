...
Guides d'installation et de configuration des outils utilisés dans la formation, **côté participants** (leurs postes). À suivre avant les ateliers Phase 2. Le volet **« Pour admin »** (licences, tenant, capacité, activation Copilot) est dans [docs/01-prerequis-admin](../docs/01-prerequis-admin/).

| # | Guide | Outil | Utilisé par | Statut |
|---|---|---|---|---|
| 00 | [Récupérer le dépôt](00-recuperer-depot.md) | Clonage de la copie client dans `C:\dev` (ou ZIP GitHub), bascule vers un repo indépendant — chemin attendu par les modèles | Tous les modules | ✅ |
| 01 | [Power BI Desktop](01-powerbi-desktop.md) | Desktop : aperçus PBIP + Prep data for AI + activation Copilot (aucun outil externe) | Modules 01, 02, 04, 05 | ✅ |
