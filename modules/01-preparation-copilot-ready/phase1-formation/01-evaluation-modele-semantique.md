...
| Mesures pré-définies | Couvrir les besoins récurrents des utilisateurs | `YTD Sales`, `MoM Growth` |
| KPI métier | Définir les indicateurs suivis par l'entreprise | `ROI`, `CAC`, `LTV` |
...
|---|---|---|
| Descriptions (tables, colonnes, mesures) | Documenter chaque élément et son usage | **Copilot ne lit que les 200 premiers caractères** ; utilisées dans les requêtes DAX et la recherche |
